...
namespace ELibraryManagement
{
    public partial class adminbookinventory : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('Książka o podanym identyfikatorze już istnieje! Spróbuj użyć innego identyfikatora');</script>");
            }
            else
            {
                addNewBook();
        ...
        public void deleteBookByID()
        {
            if (checkIfBookExists())
            {
                try
                {
                    ...
                    cmd.ExecuteNonQuery();
                    con.Close();
                    Response.Write("<script>alert('Książka została pomyślnie usunięta!');</script>");
                    GridView1.DataBind();
                }
                catch (Exception ex)
                {
            ...
            {
                Response.Write("<script>alert('Książka o tym identyfikatorze nie istnieje!');</script>");
            }
        }
            ...
            if (checkIfBookExists())
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        {
                            Response.Write("<script>alert('Rzeczywista wartość zapasów nie może być mniejsza niż wartość wydanych ksiąg');</script>");
                            return;
        ...
        public void getBookByID()
        {
            try
            {
                ...
                {
                    Response.Write("<script>alert('Nieprawidłowy identyfikator książki!');</script>");
                }
        ...
        public void addNewBook()
        {
            try
            {
                ...
                cmd.ExecuteNonQuery();
                con.Close();
                Response.Write("<script>alert('Książka została pomyślnie dodana!');</script>");
                GridView1.DataBind();
