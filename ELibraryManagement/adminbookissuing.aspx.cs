    ...
    public partial class adminbookissuing : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (checkIfBookExist() && checkIfMemberExist())
            {
                ...
                {
                    Response.Write("<script>alert('Ten użytkownik ma już tę książkę');</script>");
                }
                else
                {
                    issueBook();
            ...
            {
                Response.Write("<script>alert('Nieprawidłowy identyfikator książki lub identyfikator członka');</script>");
            }
        }
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            if (checkIfBookExist() && checkIfMemberExist())
            {
                ...
                {
                    Response.Write("<script>alert('Ten wpis nie istnieje!');</script>");
                }
        ...
        public void getNames()
        {
            try
            {
                ...
                {
                    Response.Write("<script>alert('Nieprawidłowy identyfikator użytkownika!');</script>");
                }
        ...
        public void issueBook()
        {
            try
            {
                ...
                con.Close();
                Response.Write("<script>alert('Książka została wydana pomyślnie!');</script>");
        ...
        public void returnBook()
        {
            try
            {
                ...
                if (result > 0)
                {
                    ...
                    Response.Write("<script>alert('Książka została pomyślnie zwrócona!');</script>");
                    GridView1.DataBind();
